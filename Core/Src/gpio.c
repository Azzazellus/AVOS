...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DIR_Z_Pin|DIR_X_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DIR_Z_Pin DIR_X_Pin */
  ...
  /*Configure GPIO pins : STOP_Pin ENC_BTN_Pin ENC_A_Pin ENC_B_Pin */
  GPIO_InitStruct.Pin = STOP_Pin|ENC_BTN_Pin|ENC_A_Pin|ENC_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
